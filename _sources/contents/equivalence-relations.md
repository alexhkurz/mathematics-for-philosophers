...
*resuming, we got caught in another circle of explanations ... relying on naive set theory to explain equivalence relations didnt turn out to be feasible ... so we started notes on [Set Theory](./prel-set-theory.md) ... I tried to present set theory as a theory of predicate logic but then run into the problem of having to refer to what this theory means ... which in turn led to [Model Theory](./prel-model-theory.md) ... to do that I first wanted to review syntax and semantics of [Propositional Logic](./prel-propositional-logic.md) ... for which, in turn, I needed to explain the concept of [Recursion](./prel-recursion.md) ... which led me back to set theory ... I am curious how this will continue ...*
